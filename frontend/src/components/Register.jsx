...
const Register = ({ setActiveTab }) => {
  ...
  const [pageLoading, setPageLoading] = useState(false); // Controls LoadingScreen
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setPageLoading(true); // Show LoadingScreen
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md relative">
      {pageLoading && <LoadingScreen />} {/* Overlay LoadingScreen */}
      {success ? (
